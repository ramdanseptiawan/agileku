...
// seedQuizAttempts is implemented at the end of the file
...
func seedCourses(db *sql.DB) {
	...
	courses := []map[string]interface{}{
		...
		{
	"title":       "SDN Future Leaders Program",
	"description": "A future-focused leadership program emphasizing design thinking, future skills, and mindful communication to create real-world impact.",
	"category":    "Leaders Program",
	"level":       "Intermediate",
	"duration":    "1 week",
	"instructor":  "MindShift",
	"rating":      4.9,
	"students":    3247,
	"image":       "https://images.unsplash.com/photo-1552664730-d307ca884978?w=300&h=200&fit=crop&crop=center",
	"introMaterial": map[string]interface{}{
		"title": "Welcome to SDN Future Leaders Program",
		"content": []map[string]interface{}{
			{
				"type":    "text",
				"content": "Welcome to the SDN Future Leaders Program! This transformative course is designed to help you grow as a future-ready leader by exploring design thinking, future skills, and mindful communication. Get ready to engage with real-world challenges and unlock your leadership potential.",
			},
		},
	},
	"lessons": []map[string]interface{}{
		{
			"id":    1,
			"title": "SDN FUTURE LEADERS",
			"type":  "mixed",
			"content": []map[string]interface{}{
				{
					"type":        "pdf",
					"title":       "Materi Utama SDN FUTURE LEADERS",
					"filename":    "file.pdf",
					"size":        "2.1 MB",
					"embedUrl":    "https://docs.google.com/presentation/d/1fyWaJcSiX8IG8NKy4TByDGj-R0folMlEPQGd9h2EPgQ/edit?usp=sharing",
					"downloadUrl": "http://repo.darmajaya.ac.id/4274/1/Embedded%20Systems%20Architecture%20for%20Agile%20Development_%20A%20Layers-Based%20Model%20%28%20PDFDrive%20%29.pdf",
				},
			},
		},
	...
	"preTest": map[string]interface{}{
		"id":    "pre6",
		"title": "Pre-Test: Leadership & Management",
		"questions": []map[string]interface{}{
			{
				"id":       1,
				"question": "Apa tujuan utama seorang future leader dalam organisasi?",
				"options":  []string{"Mengambil alih semua keputusan agar lebih cepat", "Memastikan prosedur dijalankan persis sesuai aturan", "Memfasilitasi tim menemukan jawaban terbaik, bukan selalu memberi jawaban", "Menjadi teladan satu-satunya agar tim selalu bergantung padanya"},
				"correctAnswer":  2,
			},
			{
				"id":       2,
				"question": "Apa esensi dari mindful communication di tempat kerja?",
				"options":  []string{"Menyampaikan pendapat dengan sopan agar tidak menyinggung", "Menyesuaikan pesan dengan tujuan, peran, dan kondisi penerima komunikasi", "Menyusun pesan seformal mungkin supaya terlihat profesional", "Memberikan informasi sebanyak mungkin agar lengkap"},
				"correctAnswer":  1,
			},
			{
				"id":       3,
				"question": "Dalam PREP Method, setelah menyampaikan Point, kita harus...",
				"options":  []string{"Memberikan Reason agar pendengar memahami alasan di balik pendapat kita", "Menjelaskan prosedur perusahaan secara rinci", "Langsung menutup dengan kesimpulan supaya efisien", "Meminta feedback segera dari audiens"},
				"correctAnswer":  0,
			},
			{
				"id":       4,
				"question": "Mengapa feedback efektif penting dalam pengembangan tim?",
				"options":  []string{"Agar orang tahu siapa yang paling benar dalam organisasi", "Untuk menjaga standar performa sekaligus membangun hubungan kerja positif", "Supaya tidak terjadi kesalahan yang sama berulang dengan cara menegur keras", "Karena ini formalitas dalam penilaian tahunan saja"},
				"correctAnswer":  1,
			},
			{
				"id":       5,
				"question": "Anda MT Logistik yang mengambil inisiatif sewa gudang tanpa approval HQ untuk menghindari penalti. National Logistics Head bertanya tajam di meeting. Apa respons tepat?",
				"options":  []string{"Mengalihkan pembicaraan ke topik volume pengiriman supaya atasan lupa", "Mengatakan prosedur memang panjang tapi keputusan ini lebih murah daripada kena penalti", "Menjawab diplomatis, \"Keputusan itu atas diskusi tim saja\" tanpa memikul tanggung jawab", "Mengkritik sistem approval HQ yang tidak realistis di lapangan"},
				"correctAnswer":  1,
			},
			{
				"id":       6,
				"question": "Sebagai MT Finance, Anda mengusulkan software Rp50 juta. Atasan menolak: \"Kenapa tak manual saja?\" Apa tanggapan Anda?",
				"options":  []string{"Manual lebih hemat, tapi risiko temuan audit jauh lebih besar & memakai waktu — lebih mahal secara total", "Itu permintaan divisi Sales, saya hanya meneruskan", "Kalau Bapak tetap keberatan, kita batalkan saja", "Tapi perusahaan kompetitor juga pakai software ini lho"},
				"correctAnswer":  0,
			},
			{
				"id":       7,
				"question": "Bagaimana prinsip memberikan feedback yang efektif?",
				"options":  []string{"Fokus pada orangnya supaya dia merasa langsung tersentuh", "Fokus pada perilaku yang diamati & dampaknya, bukan pada pribadi", "Memberikan kritik umum supaya tidak mempermalukan", "Memberikan feedback jika suasana sedang memanas biar terasa tegas"},
				"correctAnswer":  1,
			},
			{
				"id":       8,
				"question": "Dalam customer-centric problem solving, mengapa tahap empathize dilakukan lebih dulu?",
				"options":  []string{"Untuk mengidentifikasi siapa yang bisa disalahkan jika masalah muncul", "Agar dapat memahami kebutuhan dan perspektif pengguna sebelum mendefinisikan solusi", "Supaya solusi yang dibuat lebih sesuai dengan prosedur internal", "Karena ini tahap yang paling cepat diselesaikan dibanding define atau ideate"},
				"correctAnswer":  1,
			},
			{
				"id":       9,
				"question": "Dalam rapat, usulan Anda soal reward poin ditentang Finance karena dianggap memotong margin. Apa respons future leader?",
				"options":  []string{"Menjelaskan bahwa reward poin akan mempercepat cash flow & meningkatkan loyalitas pelanggan", "Mengatakan Finance selalu menghalangi ide inovasi", "Membiarkan saja, nanti kalau gagal baru buktikan", "Mengusulkan ganti program saja biar tidak ribet"},
				"correctAnswer":  0,
			},
			{
				"id":       10,
				"question": "Kenapa kemampuan berpikir kreatif, empatik & solutif penting di masa depan?",
				"options":  []string{"Supaya dapat memengaruhi opini publik di media sosial", "Agar terlihat lebih keren saat pitching ke atasan", "Untuk mendorong inovasi, membangun kepercayaan, dan mengurangi konflik tim", "Karena biasanya digunakan hanya saat presentasi ke klien"},
				"correctAnswer":  2,
			},
		},
	},
	"postTest": map[string]interface{}{
		"id":    "post6",
		"title": "Post-Test: Leadership & Management",
		"questions": []map[string]interface{}{
			{
				"id":       5,
				"question": "Anda MT Logistik yang mengambil inisiatif sewa gudang tanpa approval HQ untuk menghindari penalti. National Logistics Head bertanya tajam di meeting. Apa respons tepat?",
