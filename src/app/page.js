      ...
      <div className="w-full lg:flex-1 pt-16 lg:pt-0 pb-20 lg:pb-0">
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          {(currentView === 'overview' || currentView === 'courses' || currentView === 'quizzes' || 
            ...
            currentView === 'course-config' || currentView === 'users' || currentView === 'test-results' || 
            currentView === 'feedback-management' || currentView === 'students' || currentView === 'course-access') && currentUser.role === 'admin' && (
