...
"[project]/src/data/coursesData.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getAllCourses = ()=>{
    ...
    if (courses.length === 0) {
        try {
            const { coursesData } = __turbopack_context__.r("[project]/src/data/coursesData.js [app-client] (ecmascript)");
...
__turbopack_context__.s({
    ...
    "DEVELOPMENT_API_URL": (()=>DEVELOPMENT_API_URL),
...
const BASE_URL = ("TURBOPACK compile-time truthy", 1) ? DEVELOPMENT_API_URL : ("TURBOPACK unreachable", undefined);
...
const apiRequest = async (url, options = {})=>{
    try {
        const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].getItem('authToken');
        const config = {
            mode: 'cors',
            credentials: 'include',
            headers: {
        ...
        const fullUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiUrl"])(url);
...
const authAPI = {
    ...
    login: async (username, password)=>{
        ...
        if (response.success && response.data && response.data.token) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].setItem('authToken', response.data.token);
...
const submissionAPI = {
    ...
    uploadFile: async (file)=>{
        ...
        const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].getItem('authToken');
        const uploadUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiUrl"])('/protected/uploads/file');
...
const apiUtils = {
    ...
    clearAuthData: ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].removeItem('authToken');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].removeItem('currentUser');
    },
    // Test backend connectivity
    testConnection: async ()=>{
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/health`);
            return response.ok;
        } catch (error) {
...
const AuthProvider = ({ children })=>{
    ...
    const refreshCourses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[refreshCourses]": async ()=>{
            try {
                const coursesData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].getAllCourses();
    ...
    }["AuthProvider.useCallback[refreshCourses]"], []);
    const getCourseById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[getCourseById]": async (courseId)=>{
            try {
                // Always fetch fresh data from backend, no memory cache
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].getCourseById(courseId);
    ...
    }["AuthProvider.useCallback[getCourseById]"], []);
    // Load user data and courses on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const initializeApp = {
                "AuthProvider.useEffect.initializeApp": async ()=>{
                    try {
                        // Check if user is authenticated and verify with API
                        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUtils"].isAuthenticated()) {
                            try {
                                const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].getProfile();
                                ...
                                const userEnrollments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserEnrollments"])();
                                ...
                                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUtils"].clearAuthData();
                                setCurrentUser(null);
                                setEnrollments([]);
                            }
                        } else {
            ...
            }["AuthProvider.useEffect.initializeApp"];
            initializeApp();
        }
    }["AuthProvider.useEffect"], [
        refreshCourses
    ...
    const login = async (username, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].login(username, password);
            ...
            if (response && response.success && response.data && response.data.user && response.data.token) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeLocalStorage"].setItem('currentUser', JSON.stringify(response.data.user));
    ...
    const enrollInCourse = async (courseId)=>{
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].enrollInCourse(courseId);
    ...
    const searchCourses = async (query)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].searchCourses(query);
    ...
    const getUserProgress = async (courseId)=>{
        ...
        try {
            const progressData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCourseProgress"])(courseId);
    ...
    const refreshUserProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[refreshUserProgress]": async ()=>{
    ...
    }["AuthProvider.useCallback[refreshUserProgress]"], [
        currentUser
    ...
    const getCoursePreTest = async (courseId)=>{
        try {
            ...
            if (currentUser && currentUser.role === 'admin') {
                const { adminAPI } = await __turbopack_context__.r("[project]/src/services/api.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].getCoursePreTest(courseId);
    ...
    const getCoursePostTest = async (courseId)=>{
        try {
            ...
            if (currentUser && currentUser.role === 'admin') {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courseAPI"].getCoursePostTest(courseId);
                return response.quiz || response;
            }
        } catch (error) {
    ...
    const getStageLocks = async (courseId)=>{
        try {
            ...
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiUrl"])(`/protected/admin/courses/${courseId}/stage-locks`), {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
...
_s1(AuthProvider, "sYpXZ14RAKuNzcA2XwQzF9Bxtvc=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=_a95ce0f8._.js.map