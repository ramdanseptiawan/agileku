...
const apiRequest = async (url, options = {})=>{
    try {
        ...
        const fullUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createApiUrl"])(url);
...
const submissionAPI = {
    ...
    uploadFile: async (file)=>{
        ...
        const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$localStorage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeLocalStorage"].getItem('authToken');
        const uploadUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createApiUrl"])('/protected/uploads/file');
...
const apiUtils = {
    ...
    testConnection: async ()=>{
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/health`);
            return response.ok;
        } catch (error) {
...
const AuthProvider = ({ children })=>{
    ...
    const register = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].register(userData);
    ...
    const getStageLocks = async (courseId)=>{
        try {
            ...
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createApiUrl"])(`/protected/admin/courses/${courseId}/stage-locks`), {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af71dcc1._.js.map